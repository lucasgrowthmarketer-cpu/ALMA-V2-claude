...
const Header = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (searchResults.length > 0) {
      router.push('/machine/' + searchResults[0].slug);
      setIsSearchOpen(false);
      setSearchQuery('');
      setSearchResults([]);
    }
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-3 md:py-4">
          ...
          <nav className="hidden lg:flex items-baseline gap-5 xl:gap-6">
            <Link href="/" className="text-foreground hover:text-primary transition-colors font-medium text-sm xl:text-base">
              Accueil
            </Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[600px] bg-white border border-border rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 p-4">
                ...
                <div className="border-t mt-3 pt-3">
                  <Link href="/marques" className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <Link href="/marques" className="text-foreground hover:text-primary transition-colors font-medium text-sm xl:text-base">
              Marques
            </Link>
            <Link href="/partenaires" className="text-foreground hover:text-primary transition-colors font-medium text-sm xl:text-base">
              Nos Partenaires
            </Link>
            ...
            <Link href="/blog" className="text-foreground hover:text-primary transition-colors font-medium text-sm xl:text-base">
              Blog
            </Link>
            <Link href="/a-propos" className="text-foreground hover:text-primary transition-colors font-medium text-sm xl:text-base">
              À propos
            </Link>
          </nav>
      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-[57px] sm:top-[65px] bg-white z-40 overflow-y-auto">
          <nav className="container mx-auto px-4 py-6 flex flex-col">
            ...
            {/* CTA Button */}
            <Link href="/contact" onClick={toggleMenu} className="mt-6">

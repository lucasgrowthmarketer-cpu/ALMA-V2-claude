    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <Link href="/" className="flex flex-col items-center gap-2 p-5 bg-white rounded-xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all border border-gray-100">
            <Home size={24} className="text-[#ef6110]" />
            <span className="font-semibold text-gray-900 text-sm">Accueil</span>
          </Link>
          <Link href="/marques" className="flex flex-col items-center gap-2 p-5 bg-white rounded-xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all border border-gray-100">
            <Search size={24} className="text-[#ef6110]" />
            <span className="font-semibold text-gray-900 text-sm">Nos machines</span>
          </Link>
          <Link href="/contact" className="flex flex-col items-center gap-2 p-5 bg-white rounded-xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all border border-gray-100">

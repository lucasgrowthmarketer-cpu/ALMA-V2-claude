...
const VilleSEOPageClient = ({ ville }) => {
  // ville received via props
  ...
  if (!city) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        ...
        <Link href="/" className="text-[#ef6110] hover:underline">Retour à l'accueil</Link>
      </div>
    );
  }
            ...
            <div>
              ...
              <Card className="bg-gray-900 text-white">
                <CardContent className="p-6">
                  ...
                  <Link href="/marques" className="text-[#ef6110] hover:underline text-sm font-semibold">
...
export { cities };
export default VilleSEOPageClient;

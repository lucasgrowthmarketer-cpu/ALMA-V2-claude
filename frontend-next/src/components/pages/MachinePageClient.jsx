      ...
      <section className="bg-white py-4 border-b">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            <Link href="/" className="hover:text-[#ef6110]">Accueil</Link>
            <span>/</span>
            <Link href="/marques" className="hover:text-[#ef6110]">Marques</Link>
            <span>/</span>
            <Link href={`/marque/${machine.fabricant_slug}`} className="hover:text-[#ef6110]">{machine.fabricant}</Link>
            <span>/</span>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      ...
                      <Link href={`/marque/${machine.fabricant_slug}`} className="font-semibold text-[#ef6110] hover:underline">
                        {machine.fabricant}
                      </Link>
                    </div>
                    <div>
                      <div className="text-gray-600 mb-1">Catégorie</div>
                      <Link href={`/gamme/${machine.categorie}`} className="font-semibold text-[#ef6110] hover:underline">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedMachines.map((relMachine) => {
                ...
                return (
                  <Link key={relMachine.slug} href={`/machine/${relMachine.slug}`}>

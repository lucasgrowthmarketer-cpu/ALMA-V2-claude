    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-12 sm:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          <Link href="/" className="inline-flex items-center text-gray-300 hover:text-white mb-4 sm:mb-6 transition-colors text-sm sm:text-base">
          ...
          <Card className="border-l-4 border-[#ef6110] bg-gradient-to-r from-orange-50 to-white">
            <CardContent className="p-5 sm:p-8">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-600">
                ...
                <Link href="/contact" className="text-[#ef6110] font-semibold ml-1 hover:underline">
                  Contactez-nous →
                </Link>
              </p>
            </CardContent>

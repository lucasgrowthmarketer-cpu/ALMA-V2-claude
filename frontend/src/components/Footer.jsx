      ...
      <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-2">
              <li>
                <Link to="/" className="text-xs sm:text-sm hover:text-primary transition-colors block py-1">
                  Accueil
                </Link>
              </li>
              <li>
                <Link to="/marques" className="text-xs sm:text-sm hover:text-primary transition-colors block py-1">
                  Marques
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/a-propos" className="text-xs sm:text-sm hover:text-primary transition-colors block py-1">
                  À propos
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-xs sm:text-sm hover:text-primary transition-colors block py-1">
                  Contact
                </Link>
              </li>
              <li>

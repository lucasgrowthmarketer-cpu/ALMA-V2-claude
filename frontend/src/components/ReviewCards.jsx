...
export default function ReviewCards() {
  const reviews = [
    ...
    },
    {
      ...
      className: "[grid-area:stack] -translate-x-12 translate-y-[3.75rem] hover:-translate-y-1 before:absolute before:w-full before:rounded-2xl before:h-full before:content-[''] before:bg-gray-50/70 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-700 hover:grayscale-0 before:left-0 before:top-0 before:z-10",
    },
    {
      ...
      className: "[grid-area:stack] translate-x-8 translate-y-[7.5rem] hover:translate-y-[3.75rem] before:absolute before:w-full before:rounded-2xl before:h-full before:content-[''] before:bg-gray-50/70 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-700 hover:grayscale-0 before:left-0 before:top-0 before:z-10",
    },
    {
      ...
      className: '[grid-area:stack] translate-x-28 translate-y-[11.25rem] hover:translate-y-[7.5rem]',
    },
  ];

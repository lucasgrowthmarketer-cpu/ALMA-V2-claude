...
import { machinesData, machinePhotos } from '../data/machinesData';
...
const BrandPage = () => {
  ...
  const getMachineImage = (machine) => {
    ...
    if (cat === 'usinage') {
      if (subcat.includes('tournage')) return images.usinage.cncLathe1;
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span>/</span>
            <Link to="/marques" className="hover:text-white transition-colors">Marques</Link>
            <span>/</span>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <span className={'px-4 py-1.5 rounded-full text-sm font-semibold ' +
                  (brandInfo.categorie === 'usinage' ? 'bg-blue-500 text-white' :
                   brandInfo.categorie === 'tolerie' ? 'bg-green-500 text-white' :
                   'bg-purple-500 text-white')
                }>
                  {brandInfo.categorie.charAt(0).toUpperCase() + brandInfo.categorie.slice(1)}
                </span>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {brandsSimple
              .filter(b => b.slug !== brandSlug && b.categorie === brandInfo.categorie)
              .slice(0, 6)
              .map((brand) => (
